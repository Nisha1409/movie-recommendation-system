	...
	return (
		<div className='hero-bg relative'>
			...
			<div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
				...
				<p className='text-lg mb-4'>Watch anywhere.</p>
				<p className='mb-4'>Ready to watch?</p>
					
					<button onClick={handleFormSubmit} className='bg-red-600 text-xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center'>
						Get Started
